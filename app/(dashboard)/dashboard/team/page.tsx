      ...
      <Section className="py-ds-4">
        <Tabs defaultValue="members">
          ...
          <TabsContent value="members" className="mt-6">
            ...
            {members.length === 0 ? (
              <Card className="p-12 text-center rounded-ds-lg shadow-ds-md">
                <p className="text-muted-foreground mb-ds-2">No team members yet</p>
          ...
          <TabsContent value="schedule" className="mt-ds-3">
            {members.length === 0 ? (
              <Card className="p-12 text-center rounded-ds-lg shadow-ds-md">
