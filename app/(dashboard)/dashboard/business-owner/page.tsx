...
export default function BusinessOwnerDashboardPage() {
  ...
  return (
    <Section className="space-y-ds-4">
      ...
      {showTrialSuccess && (
        <Alert className="border-green-500 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-2 relative rounded-ds-lg">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="ds-heading-1 mb-ds-1">Business Dashboard</h1>
          <p className="text-muted-foreground ds-body">Welcome back, {userName}! 👋</p>
        </div>
        <div className="flex items-center gap-ds-2">
          <div className="inline-flex items-center gap-ds-1 px-4 py-2 rounded-ds bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 border border-blue-200 dark:border-blue-800">
      ...
      <div className="grid gap-ds-3 md:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <Card key={stat.title} className="group hover:shadow-ds-xl hover:-translate-y-1 transition-all duration-300 border-2 rounded-ds-lg shadow-ds-md">
            <CardHeader className={`flex flex-row items-center justify-between pb-2 bg-gradient-to-br ${stat.bgGradient} rounded-t-ds-lg`}>
              <CardTitle className="ds-body-sm font-medium">
                {stat.title}
              </CardTitle>
              <div className={`w-10 h-10 rounded-ds bg-gradient-to-br ${stat.gradient} flex items-center justify-center shadow-ds-md group-hover:scale-110 transition-transform`}>
      ...
      {!businessProfile && (
        <Card className="border-2 border-dashed rounded-ds-lg shadow-ds-md">
