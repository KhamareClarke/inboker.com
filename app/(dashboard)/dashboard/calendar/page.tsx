  ...
  return (
    <div>
      ...
      <Section className="py-ds-4">
        <div className="flex items-center justify-between mb-ds-3 sm:mb-ds-4">
          <p className="text-xs sm:text-sm text-muted-foreground">
            View your appointments and schedule
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-ds-2 sm:gap-ds-3">
          <Card className="p-ds-2 sm:p-ds-3 lg:col-span-2 rounded-ds-lg shadow-ds-md">
            <Calendar
              mode="single"
              selected={date}
              onSelect={setDate}
          ...
          <div className="space-y-ds-2 sm:space-y-ds-3">
            <Card className="p-ds-2 rounded-ds-lg shadow-ds-md">
              <CardHeader>
