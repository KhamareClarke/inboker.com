...
import { formatCancellationHint, parseCancellationPolicy } from '@/lib/business/cancellation-policy';
...
export default function CustomerBookingsPage() {
  ...
  return (
    <Section className="space-y-ds-4 sm:space-y-ds-5 lg:space-y-ds-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-ds-2">
        <div className="flex-1 min-w-0">
          <h1 className="font-display text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
            My Bookings
          </h1>
        ...
        <DialogContent>
          ...
          {selectedBooking && (
            <div className="space-y-4">
              ...
              <Alert>
                <AlertDescription>
                  {formatCancellationHint(
                    selectedBooking.start_time,
                    parseCancellationPolicy(selectedBooking.business_profiles?.custom_settings)
                  )}
                </AlertDescription>
              </Alert>
              <div>
        ...
        <DialogContent className="max-w-[95vw] sm:max-w-lg md:max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter className="flex-col sm:flex-row gap-2 sm:gap-0 px-1 sm:px-0">
            ...
            <Button
              ...
              className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white border-0 order-1 sm:order-2"
            >
              {submittingReview ? (
                <>
                  <Loader2 className="h-4 w-4 mr-2 animate-spin" />
