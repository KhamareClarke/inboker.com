  ...
  return (
    <div className="flex flex-col overflow-hidden">
      <section className="relative">
        ...
        <div className="container relative mx-auto max-w-screen-xl px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <div className="space-y-6 sm:space-y-8 lg:space-y-10">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 border border-blue-200 dark:border-blue-800">
                <Sparkles className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-blue-600" />
                <span className="text-xs sm:text-sm font-medium bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                <Badge variant="secondary" className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm border border-blue-200 dark:border-blue-800 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20">
                  <Bot className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1 sm:mr-1.5" />
                  AI-Powered
                </Badge>
                <Badge variant="secondary" className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm border border-emerald-200 dark:border-emerald-800 bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20">
                  <Radio className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1 sm:mr-1.5" />
                  Real-Time Sync
                </Badge>
                <Badge variant="secondary" className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm border border-amber-200 dark:border-amber-800 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
                <Link href="/signup" className="group w-full sm:w-auto">
                  <Button size="lg" className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-600 hover:from-blue-700 hover:via-cyan-700 hover:to-blue-700 text-base sm:text-lg px-6 sm:px-10 h-14 sm:h-16 w-full sm:w-auto shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all duration-300 bg-[length:200%_100%] hover:bg-right">
                ...
                <Link href="/demo" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="text-base sm:text-lg px-6 sm:px-10 h-14 sm:h-16 w-full sm:w-auto border-2 hover:bg-muted/50 backdrop-blur-sm transition-all duration-300">
                    Book a Demo
                  </Button>
                </Link>
              </div>

              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6 pt-2 sm:pt-4 text-xs sm:text-sm text-muted-foreground">
            ...
            <div className="relative lg:h-[600px] mt-8 lg:mt-0">
              ...
              <div className="relative space-y-3 sm:space-y-4">
                <Card className="shadow-2xl border-2 border-blue-100 dark:border-blue-900 backdrop-blur-sm bg-background/80 hover:shadow-blue-500/20 hover:shadow-3xl transition-all duration-500 hover:-translate-y-1">
                  <CardHeader className="border-b bg-gradient-to-r from-blue-50 via-cyan-50 to-indigo-50 dark:from-blue-950/50 dark:via-cyan-950/50 dark:to-indigo-950/50 p-4 sm:p-6">
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-blue-600 to-cyan-600 flex items-center justify-center flex-shrink-0">
                          <Calendar className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
                        </div>
                        <CardTitle className="text-sm sm:text-base lg:text-lg truncate">Your AI-Powered Space</CardTitle>
                      </div>
                      <Badge className="bg-green-500 text-white border-0 text-xs flex-shrink-0">Live</Badge>
                    </div>
                  </CardHeader>
                  <CardContent className="p-4 sm:p-6 space-y-3 sm:space-y-4">
                    <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 rounded-xl border border-blue-100 dark:border-blue-900">
                      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                        <Bot className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 flex-shrink-0" />
                        <span className="font-semibold text-sm sm:text-base truncate">AI Scheduler Active</span>
                      </div>
                      <Badge variant="secondary" className="text-xs flex-shrink-0">92% efficiency</Badge>
                    </div>

                    <div className="space-y-2">
                      <div className="flex items-center justify-between p-2.5 sm:p-3 bg-muted/50 rounded-lg hover:bg-muted transition-colors">
                        <span className="text-xs sm:text-sm font-medium">Today's bookings</span>
                        <Badge className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white border-0 text-xs">12 confirmed</Badge>
                      </div>
                      <div className="flex items-center justify-between p-2.5 sm:p-3 bg-muted/50 rounded-lg hover:bg-muted transition-colors">
                        <span className="text-xs sm:text-sm font-medium">This week</span>
                        <Badge variant="secondary" className="text-xs">48 scheduled</Badge>
                      </div>
                      <div className="flex items-center justify-between p-2.5 sm:p-3 bg-muted/50 rounded-lg hover:bg-muted transition-colors">
                        <span className="text-xs sm:text-sm font-medium">Revenue</span>
                        <Badge variant="secondary" className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs">+38% ↑</Badge>
                      </div>
                    </div>

                    <div className="grid grid-cols-3 gap-2 sm:gap-3 pt-2">
                      <div className="p-3 sm:p-4 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 rounded-lg text-center border border-blue-100 dark:border-blue-900 hover:scale-105 transition-transform cursor-pointer">
                        <div className="text-xs text-muted-foreground mb-1">9:00 AM</div>
                        <div className="text-xs sm:text-sm font-semibold">Open</div>
                      </div>
                      <div className="p-3 sm:p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 rounded-lg text-center border-2 border-green-500 shadow-lg shadow-green-500/20 hover:scale-105 transition-transform cursor-pointer">
                        <div className="text-xs text-muted-foreground mb-1">10:00 AM</div>
                        <div className="text-xs sm:text-sm font-semibold text-green-700 dark:text-green-400">Booked</div>
                      </div>
                      <div className="p-3 sm:p-4 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 rounded-lg text-center border border-blue-100 dark:border-blue-900 hover:scale-105 transition-transform cursor-pointer">
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-4">
                  <Card className="border-2 border-orange-100 dark:border-orange-900 bg-gradient-to-br from-orange-50/50 to-amber-50/50 dark:from-orange-950/20 dark:to-amber-950/20 hover:scale-105 transition-transform">
                    <CardContent className="p-3 sm:p-4 text-center">
                      <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent">92%</div>
                  ...
                  <Card className="border-2 border-green-100 dark:border-green-900 bg-gradient-to-br from-green-50/50 to-emerald-50/50 dark:from-green-950/20 dark:to-emerald-950/20 hover:scale-105 transition-transform">
                    <CardContent className="p-3 sm:p-4 text-center">
                      <div className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">38%</div>
      ...
      <section className="container mx-auto max-w-screen-xl px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-32">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 space-y-3 sm:space-y-4">
          <Badge variant="outline" className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm">
            <Zap className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1 sm:mr-1.5 text-yellow-500" />
            Core Capabilities
          </Badge>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold px-4 sm:px-0">
            Built for{' '}
      ...
      <section className="relative py-12 sm:py-16 md:py-20 lg:py-32">
        ...
        <div className="container relative mx-auto max-w-screen-xl px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground px-4 sm:px-0">Get live in three effortless steps</p>
          </div>
      ...
      <section className="container mx-auto max-w-screen-xl px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-32">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16 space-y-3 sm:space-y-4">
          <Badge variant="outline" className="px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm">
            <BarChart className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1 sm:mr-1.5 text-green-600" />
            Complete Platform
          </Badge>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold px-4 sm:px-0">
            Everything You Need.{' '}
      ...
      <section className="container mx-auto max-w-screen-xl px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-32">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-muted-foreground px-4 sm:px-0">See what our customers achieve with Inboker</p>
        </div>
        <Testimonials />
      </section>
      ...
      <section className="relative py-12 sm:py-16 md:py-20 lg:py-32">
        ...
        <div className="container relative mx-auto max-w-4xl px-4 sm:px-6 text-center">
          <div className="space-y-6 sm:space-y-8">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight px-4 sm:px-0">
              Start taking bookings in 5 minutes
            </h2>

            <p className="text-base sm:text-lg lg:text-xl text-blue-50 max-w-2xl mx-auto px-4 sm:px-0">
              Brand it, connect your calendar, go live. No code required. No credit card needed.
            </p>

            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-2 sm:pt-4">
              <Link href="/signup" className="w-full sm:w-auto">
                <Button size="lg" variant="secondary" className="text-base sm:text-lg px-6 sm:px-10 h-14 sm:h-16 shadow-2xl hover:scale-105 transition-transform w-full sm:w-auto">
                  Start Free Trial
                  <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </Button>
              </Link>
              <Link href="/demo" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="text-base sm:text-lg px-6 sm:px-10 h-14 sm:h-16 bg-white/10 border-white/20 hover:bg-white/20 text-white backdrop-blur-sm w-full sm:w-auto">
                  Book a Demo
                </Button>
              </Link>
            </div>
