...
export default function AdminLoginPage() {
  ...
  return (
    <Section
      as="div"
      className="min-h-screen flex items-center justify-center py-ds-6 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"
    >
      <Container size="narrow" className="max-w-md w-full">
        <Card className="w-full rounded-ds-lg border-2 border-purple-500/20 shadow-ds-xl">
          <CardHeader className="space-y-2 text-center pb-2">
            <div className="flex justify-center mb-ds-2">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center shadow-ds-md">
                <Shield className="h-8 w-8 text-white" />
              </div>
            </div>
            <CardTitle className="ds-heading-2 bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
              Admin Login
            </CardTitle>
            <CardDescription className="ds-body-sm">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-ds-4">
              ...
              <div className="text-center ds-body-sm text-muted-foreground">
                <p>Default credentials:</p>
                <p className="font-mono text-xs mt-ds-1">
                  Email: {ADMIN_EMAIL}
                </p>
