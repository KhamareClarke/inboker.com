...
export default function BusinessDashboardPage() {
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(to bottom right, ${primary}08, ${secondary}08, #f8fafc)`,
      }}
    >
      <div
        className="border-b backdrop-blur-sm"
        style={{
          background: `linear-gradient(135deg, ${primary}12 0%, ${secondary}08 100%)`,
      ...
      <Section className="py-ds-4 sm:py-ds-5 lg:py-ds-6">
        <Container size="wide">
        <Card className="mb-ds-4 rounded-ds-lg shadow-ds-md" style={{
