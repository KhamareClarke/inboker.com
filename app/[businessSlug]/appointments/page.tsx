  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800">
      <Section className="py-ds-4 sm:py-ds-5 lg:py-ds-6">
        <Container size="wide">
        {/* Header */}
        <div className="mb-ds-3 sm:mb-ds-4">
          <div className="flex items-center justify-between mb-ds-2 sm:mb-ds-3">
          ...
          <div>
            <h1 className="ds-heading-2 mb-ds-1">Appointments</h1>
        ...
        {/* Filters and Search */}
        <Card className="mb-ds-3 rounded-ds-lg shadow-ds-md">
