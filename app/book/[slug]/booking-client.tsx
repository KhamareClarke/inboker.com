...
export default function BookingClient() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 p-4 py-ds-6">
      <Section>
        <Container size="narrow">
          <div className="text-center mb-ds-4">
            <h1 className="font-display text-3xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-ds-1">
              {workspace.name}
            </h1>
            <p className="text-muted-foreground ds-body">Book your appointment in 3 easy steps</p>
          </div>

          <Card className="rounded-ds-lg shadow-ds-lg">
