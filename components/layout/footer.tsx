...
export function Footer() {
  ...
  return (
    <footer className="border-t bg-muted/30 mt-auto">
      <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="border-t mt-8 sm:mt-12 pt-6 sm:pt-8 text-center text-xs sm:text-sm text-muted-foreground">
